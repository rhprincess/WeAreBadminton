...
object SummerLikeTheme : BaseTheme {
    ...
    private val md_theme_light_inversePrimary = Color(0xFF9AD768)
    private val md_theme_light_surfaceTint = Color(0xFF366B00)
    ...
    private val md_theme_dark_onPrimaryContainer = Color(0xFFB5F481)
    ...
    private val md_theme_dark_inversePrimary = Color(0xFF366B00)
    private val md_theme_dark_surfaceTint = Color(0xFF9AD768)
