...
object OrangeTheme: BaseTheme {
    ...
    private val md_theme_light_secondaryContainer = Color(0xFFFEDCBE)
    ...
    private val md_theme_light_tertiaryContainer = Color(0xFFDBE8B5)
    private val md_theme_light_onTertiaryContainer = Color(0xFF161F01)
    ...
    private val md_theme_light_inversePrimary = Color(0xFFFFB86F)
    private val md_theme_light_surfaceTint = Color(0xFF8A5100)
    ...
    private val md_theme_dark_onPrimaryContainer = Color(0xFFFFDCBD)
    ...
    private val md_theme_dark_onSecondaryContainer = Color(0xFFFEDCBE)
    private val md_theme_dark_tertiary = Color(0xFFBFCC9A)
    private val md_theme_dark_onTertiary = Color(0xFF2A3410)
    private val md_theme_dark_tertiaryContainer = Color(0xFF404B25)
    private val md_theme_dark_onTertiaryContainer = Color(0xFFDBE8B5)
    ...
    private val md_theme_dark_inversePrimary = Color(0xFF8A5100)
    private val md_theme_dark_surfaceTint = Color(0xFFFFB86F)
